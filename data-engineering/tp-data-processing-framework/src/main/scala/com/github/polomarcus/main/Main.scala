...
object Main {
  def main(args: Array[String]) {
    ...
    spark.sql("SELECT title FROM news").show()
    ...
    filteredNewsAboutClimate.select("presenter").show()
    ...
    filteredNewsAboutClimate.write.partitionBy("media").parquet("coucou-dossier")
